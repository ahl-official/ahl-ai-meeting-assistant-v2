...
export default function AdminIndex() {
    ...
    const stats = [
        { icon: '👥', value: users.length, label: 'Total Users', sub: `${activeUsers} active`, color: '#2563eb' },
        { icon: '📋', value: meetings.length, label: 'Total Meetings', sub: `across all users`, color: '#7c3aed' },
            ...
            <main className={styles.main}>
                <div className={styles.header}>
                    ...
                    <div className={styles.headerActions}>
                        ...
                        <button className="btn btn-ghost" onClick={() => { signOut(); router.push('/admin/login'); }}>
                            Sign out
                        </button>
                    </div>
                </div>
